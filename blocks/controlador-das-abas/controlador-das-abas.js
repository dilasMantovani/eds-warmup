...
function handleTabChange(e){
    ...
    const tabData = Array.from(groupTabSections)?.map((tabElement) => {return {'tabId' : tabElement.getAttribute('data-tab-id'), 'tabTitle': tabElement.getAttribute('data-tab-title')}})
